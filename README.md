...
| `llms.txt` | Machine-readable organization context for crawlers and LLM tools |
...
| [`profile/README.md`](profile/README.md) | GitHub-rendered landing page with Start Here, public repository directory, and risk boundary |
